...
class LocationProvider119 extends ChangeNotifier {
...
class sp05galagama_02Page extends StatefulWidget {
  const sp05galagama_02Page({super.key});

  @override
  State<sp05galagama_02Page> createState() => _sp05galagama_02PageState();
}

class _sp05galagama_02PageState extends State<sp05galagama_02Page> {
  late GoogleMapController _controller;
  late LocationProvider119 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05galagama_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider119>(context, listen: false);
  }
