...
class LocationProvider114 extends ChangeNotifier {
...
class sp05a_01Page extends StatefulWidget {
  const sp05a_01Page({super.key});

  @override
  State<sp05a_01Page> createState() => _sp05a_01PageState();
}

class _sp05a_01PageState extends State<sp05a_01Page> {
  late GoogleMapController _controller;
  late LocationProvider114 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05a_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider114>(context, listen: false);
  }
