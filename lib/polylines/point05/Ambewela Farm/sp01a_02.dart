...
class LocationProvider115 extends ChangeNotifier {
...
class sp05a_02Page extends StatefulWidget {
  const sp05a_02Page({super.key});

  @override
  State<sp05a_02Page> createState() => _sp05a_02PageState();
}

class _sp05a_02PageState extends State<sp05a_02Page> {
  late GoogleMapController _controller;
  late LocationProvider115 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05a_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider115>(context, listen: false);
  }
