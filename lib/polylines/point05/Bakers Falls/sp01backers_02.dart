...
class LocationProvider117 extends ChangeNotifier {
...
class sp05backers_02Page extends StatefulWidget {
  const sp05backers_02Page({super.key});

  @override
  State<sp05backers_02Page> createState() => _sp05backers_02PageState();
}

class _sp05backers_02PageState extends State<sp05backers_02Page> {
  late GoogleMapController _controller;
  late LocationProvider117 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05backers_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider117>(context, listen: false);
  }
