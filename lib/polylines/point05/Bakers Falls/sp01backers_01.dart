...
class LocationProvider116 extends ChangeNotifier {
...
class sp05backers_01Page extends StatefulWidget {
  const sp05backers_01Page({super.key});

  @override
  State<sp05backers_01Page> createState() => _sp05backers_01PageState();
}

class _sp05backers_01PageState extends State<sp05backers_01Page> {
  late GoogleMapController _controller;
  late LocationProvider116 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05backers_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider116>(context, listen: false);
  }
