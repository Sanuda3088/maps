...
class LocationProvider129 extends ChangeNotifier {
...
class sp05newz_02Page extends StatefulWidget {
  const sp05newz_02Page({super.key});

  @override
  State<sp05newz_02Page> createState() => _sp05newz_02PageState();
}

class _sp05newz_02PageState extends State<sp05newz_02Page> {
  late GoogleMapController _controller;
  late LocationProvider129 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05nwz_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider129>(context, listen: false);
  }
