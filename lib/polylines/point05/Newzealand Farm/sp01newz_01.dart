...
class LocationProvider128 extends ChangeNotifier {
...
class sp05newz_01Page extends StatefulWidget {
  const sp05newz_01Page({super.key});

  @override
  State<sp05newz_01Page> createState() => _sp05newz_01PageState();
}

class _sp05newz_01PageState extends State<sp05newz_01Page> {
  late GoogleMapController _controller;
  late LocationProvider128 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05nwz_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider128>(context, listen: false);
  }
