...
class LocationProvider109 extends ChangeNotifier {
...
class sp05bopath_01Page extends StatefulWidget {
  const sp05bopath_01Page({super.key});

  @override
  State<sp05bopath_01Page> createState() => _sp05bopath_01PageState();
}

class _sp05bopath_01PageState extends State<sp05bopath_01Page> {
  late GoogleMapController _controller;
  late LocationProvider109 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05bopath_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider109>(context, listen: false);
  }
