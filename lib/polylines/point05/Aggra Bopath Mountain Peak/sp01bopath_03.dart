...
class LocationProvider111 extends ChangeNotifier {
...
class sp05bopath_03Page extends StatefulWidget {
  const sp05bopath_03Page({super.key});

  @override
  State<sp05bopath_03Page> createState() => _sp05bopath_03PageState();
}

class _sp05bopath_03PageState extends State<sp05bopath_03Page> {
  late GoogleMapController _controller;
  late LocationProvider111 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05bopath_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider111>(context, listen: false);
  }
