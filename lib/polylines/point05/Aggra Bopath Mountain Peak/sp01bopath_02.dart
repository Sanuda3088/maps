...
class LocationProvider110 extends ChangeNotifier {
...
class sp05bopath_02Page extends StatefulWidget {
  const sp05bopath_02Page({super.key});

  @override
  State<sp05bopath_02Page> createState() => _sp05bopath_02PageState();
}

class _sp05bopath_02PageState extends State<sp05bopath_02Page> {
  late GoogleMapController _controller;
  late LocationProvider110 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05bopath_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider110>(context, listen: false);
  }
