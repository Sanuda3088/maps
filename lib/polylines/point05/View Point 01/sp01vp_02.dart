...
class LocationProvider131 extends ChangeNotifier {
...
class sp05vp_02Page extends StatefulWidget {
  const sp05vp_02Page({super.key});

  @override
  State<sp05vp_02Page> createState() => _sp05vp_02PageState();
}

class _sp05vp_02PageState extends State<sp05vp_02Page> {
  late GoogleMapController _controller;
  late LocationProvider131 _locationProvider;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider131>(context, listen: false);
  }
