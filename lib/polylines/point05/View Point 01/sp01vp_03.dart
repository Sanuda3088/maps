...
class LocationProvider132 extends ChangeNotifier {
...
class sp05vp_03Page extends StatefulWidget {
  const sp05vp_03Page({super.key});

  @override
  State<sp05vp_03Page> createState() => _sp05vp_03PageState();
}

class _sp05vp_03PageState extends State<sp05vp_03Page> {
  late GoogleMapController _controller;
  late LocationProvider132 _locationProvider;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider132>(context, listen: false);
  }
