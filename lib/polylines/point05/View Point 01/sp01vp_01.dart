...
class LocationProvider130 extends ChangeNotifier {
...
class sp05vp_01Page extends StatefulWidget {
  const sp05vp_01Page({super.key});

  @override
  State<sp05vp_01Page> createState() => _sp05vp_01PageState();
}

class _sp05vp_01PageState extends State<sp05vp_01Page> {
  late GoogleMapController _controller;
  late LocationProvider130 _locationProvider;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider130>(context, listen: false);
  }
