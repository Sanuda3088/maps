...
class LocationProvider120 extends ChangeNotifier {
...
class sp05we_01Page extends StatefulWidget {
  const sp05we_01Page({super.key});

  @override
  State<sp05we_01Page> createState() => _sp05we_01PageState();
}

class _sp05we_01PageState extends State<sp05we_01Page> {
  late GoogleMapController _controller;
  late LocationProvider120 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05we_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider120>(context, listen: false);
  }
