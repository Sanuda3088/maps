...
class LocationProvider121 extends ChangeNotifier {
...
class sp05we_02Page extends StatefulWidget {
  const sp05we_02Page({super.key});

  @override
  State<sp05we_02Page> createState() => _sp05we_02PageState();
}

class _sp05we_02PageState extends State<sp05we_02Page> {
  late GoogleMapController _controller;
  late LocationProvider121 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05we_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider121>(context, listen: false);
  }
