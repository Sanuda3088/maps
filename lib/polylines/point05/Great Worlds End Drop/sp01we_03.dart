...
class LocationProvider122 extends ChangeNotifier {
...
class sp05we_03Page extends StatefulWidget {
  const sp05we_03Page({super.key});

  @override
  State<sp05we_03Page> createState() => _sp05we_03PageState();
}

class _sp05we_03PageState extends State<sp05we_03Page> {
  late GoogleMapController _controller;
  late LocationProvider122 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05we_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider122>(context, listen: false);
  }
