...
class LocationProvider127 extends ChangeNotifier {
...
class sp05mwe_02Page extends StatefulWidget {
  const sp05mwe_02Page({super.key});

  @override
  State<sp05mwe_02Page> createState() => _sp05mwe_02PageState();
}

class _sp05mwe_02PageState extends State<sp05mwe_02Page> {
  late GoogleMapController _controller;
  late LocationProvider127 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05mwe_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider127>(context, listen: false);
  }
