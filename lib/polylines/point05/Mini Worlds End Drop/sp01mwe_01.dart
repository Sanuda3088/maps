...
class LocationProvider126 extends ChangeNotifier {
...
class sp05mwe_01Page extends StatefulWidget {
  const sp05mwe_01Page({super.key});

  @override
  State<sp05mwe_01Page> createState() => _sp05mwe_01PageState();
}

class _sp05mwe_01PageState extends State<sp05mwe_01Page> {
  late GoogleMapController _controller;
  late LocationProvider126 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05mwe_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider126>(context, listen: false);
  }
