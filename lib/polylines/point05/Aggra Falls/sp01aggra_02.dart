...
class LocationProvider113 extends ChangeNotifier {
...
class sp05aggra_02Page extends StatefulWidget {
  const sp05aggra_02Page({super.key});

  @override
  State<sp05aggra_02Page> createState() => _sp05aggra_02PageState();
}

class _sp05aggra_02PageState extends State<sp05aggra_02Page> {
  late GoogleMapController _controller;
  late LocationProvider113 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05aggra_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider113>(context, listen: false);
  }
