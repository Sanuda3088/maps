...
class LocationProvider112 extends ChangeNotifier {
...
class sp05aggra_01Page extends StatefulWidget {
  const sp05aggra_01Page({super.key});

  @override
  State<sp05aggra_01Page> createState() => _sp05aggra_01PageState();
}

class _sp05aggra_01PageState extends State<sp05aggra_01Page> {
  late GoogleMapController _controller;
  late LocationProvider112 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05aggra_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider112>(context, listen: false);
  }
