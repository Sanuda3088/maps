...
class LocationProvider134 extends ChangeNotifier {
...
class sp05vp2_02Page extends StatefulWidget {
  const sp05vp2_02Page({super.key});

  @override
  State<sp05vp2_02Page> createState() => _sp05vp2_02PageState();
}

class _sp05vp2_02PageState extends State<sp05vp2_02Page> {
  late GoogleMapController _controller;
  late LocationProvider134 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05vp_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider134>(context, listen: false);
  }
