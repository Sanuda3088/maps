...
class LocationProvider133 extends ChangeNotifier {
...
class sp05vp2_01Page extends StatefulWidget {
  const sp05vp2_01Page({super.key});

  @override
  State<sp05vp2_01Page> createState() => _sp05vp2_01PageState();
}

class _sp05vp2_01PageState extends State<sp05vp2_01Page> {
  late GoogleMapController _controller;
  late LocationProvider133 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05vp_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider133>(context, listen: false);
  }
