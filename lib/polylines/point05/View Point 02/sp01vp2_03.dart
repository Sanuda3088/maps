...
class LocationProvider135 extends ChangeNotifier {
...
class sp05vp2_03Page extends StatefulWidget {
  const sp05vp2_03Page({super.key});

  @override
  State<sp05vp2_03Page> createState() => _sp05vp2_03PageState();
}

class _sp05vp2_03PageState extends State<sp05vp2_03Page> {
  late GoogleMapController _controller;
  late LocationProvider135 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05vp_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider135>(context, listen: false);
  }
