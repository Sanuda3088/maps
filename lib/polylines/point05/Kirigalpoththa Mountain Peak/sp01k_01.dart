...
class LocationProvider123 extends ChangeNotifier {
...
class sp05k_01Page extends StatefulWidget {
  const sp05k_01Page({super.key});

  @override
  State<sp05k_01Page> createState() => _sp05k_01PageState();
}

class _sp05k_01PageState extends State<sp05k_01Page> {
  late GoogleMapController _controller;
  late LocationProvider123 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05k_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider123>(context, listen: false);
  }
