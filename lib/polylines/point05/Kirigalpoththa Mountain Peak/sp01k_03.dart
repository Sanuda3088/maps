...
class LocationProvider125 extends ChangeNotifier {
...
class sp05k_03Page extends StatefulWidget {
  const sp05k_03Page({super.key});

  @override
  State<sp05k_03Page> createState() => _sp05k_03PageState();
}

class _sp05k_03PageState extends State<sp05k_03Page> {
  late GoogleMapController _controller;
  late LocationProvider125 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05k_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider125>(context, listen: false);
  }
