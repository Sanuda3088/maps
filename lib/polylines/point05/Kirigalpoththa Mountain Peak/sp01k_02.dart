...
class LocationProvider124 extends ChangeNotifier {
...
class sp05k_02Page extends StatefulWidget {
  const sp05k_02Page({super.key});

  @override
  State<sp05k_02Page> createState() => _sp05k_02PageState();
}

class _sp05k_02PageState extends State<sp05k_02Page> {
  late GoogleMapController _controller;
  late LocationProvider124 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint05.sp05k_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider124>(context, listen: false);
  }
