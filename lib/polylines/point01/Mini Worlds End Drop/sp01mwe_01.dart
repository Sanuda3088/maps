...
class LocationProvider21 extends ChangeNotifier {
...
class sp01mwe_01Page extends StatefulWidget {
  const sp01mwe_01Page({super.key});

  @override
  State<sp01mwe_01Page> createState() => _sp01mwe_01PageState();
}

class _sp01mwe_01PageState extends State<sp01mwe_01Page> {
  late GoogleMapController _controller;
  late LocationProvider21 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01mwe_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider21>(context, listen: false);
  }
