...
class LocationProvider23 extends ChangeNotifier {
...
class sp01mwe_03Page extends StatefulWidget {
  const sp01mwe_03Page({super.key});

  @override
  State<sp01mwe_03Page> createState() => _sp01mwe_03PageState();
}

class _sp01mwe_03PageState extends State<sp01mwe_03Page> {
  late GoogleMapController _controller;
  late LocationProvider23 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01mwe_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider23>(context, listen: false);
  }
