...
class LocationProvider22 extends ChangeNotifier {
...
class sp01mwe_02Page extends StatefulWidget {
  const sp01mwe_02Page({super.key});

  @override
  State<sp01mwe_02Page> createState() => _sp01mwe_02PageState();
}

class _sp01mwe_02PageState extends State<sp01mwe_02Page> {
  late GoogleMapController _controller;
  late LocationProvider22 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01mwe_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider22>(context, listen: false);
  }
