...
class LocationProvider8 extends ChangeNotifier {
...
class sp01aggra_02Page extends StatefulWidget {
  const sp01aggra_02Page({super.key});

  @override
  State<sp01aggra_02Page> createState() => _sp01aggra_02PageState();
}

class _sp01aggra_02PageState extends State<sp01aggra_02Page> {
  late GoogleMapController _controller;
  late LocationProvider8 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01aggra_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider8>(context, listen: false);
  }
