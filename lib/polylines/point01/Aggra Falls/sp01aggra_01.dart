...
class LocationProvider7 extends ChangeNotifier {
...
class sp01aggra_01Page extends StatefulWidget {
  const sp01aggra_01Page({super.key});

  @override
  State<sp01aggra_01Page> createState() => _sp01aggra_01PageState();
}

class _sp01aggra_01PageState extends State<sp01aggra_01Page> {
  late GoogleMapController _controller;
  late LocationProvider7 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01aggra_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider7>(context, listen: false);
  }
