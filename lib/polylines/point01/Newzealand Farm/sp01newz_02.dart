...
class LocationProvider10 extends ChangeNotifier {
...
class sp01newz_02Page extends StatefulWidget {
  const sp01newz_02Page({super.key});

  @override
  State<sp01newz_02Page> createState() => _sp01newz_02PageState();
}

class _sp01newz_02PageState extends State<sp01newz_02Page> {
  late GoogleMapController _controller;
  late LocationProvider10 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01newz_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider10>(context, listen: false);
  }
