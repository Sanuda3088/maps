...
class LocationProvider11 extends ChangeNotifier {
...
class sp01newz_03Page extends StatefulWidget {
  const sp01newz_03Page({super.key});

  @override
  State<sp01newz_03Page> createState() => _sp01newz_03PageState();
}

class _sp01newz_03PageState extends State<sp01newz_03Page> {
  late GoogleMapController _controller;
  late LocationProvider11 _locationProvider;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider11>(context, listen: false);
  }
