...
class LocationProvider9 extends ChangeNotifier {
...
class sp01newz_01Page extends StatefulWidget {
  const sp01newz_01Page({super.key});

  @override
  State<sp01newz_01Page> createState() => _sp01newz_01PageState();
}

class _sp01newz_01PageState extends State<sp01newz_01Page> {
  late GoogleMapController _controller;
  late LocationProvider9 _locationProvider;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider9>(context, listen: false);
  }
