...
class LocationProvider13 extends ChangeNotifier {
...
class sp01backers_02Page extends StatefulWidget {
  const sp01backers_02Page({super.key});

  @override
  State<sp01backers_02Page> createState() => _sp01backers_02PageState();
}

class _sp01backers_02PageState extends State<sp01backers_02Page> {
  late GoogleMapController _controller;
  late LocationProvider13 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01backers_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider13>(context, listen: false);
  }
