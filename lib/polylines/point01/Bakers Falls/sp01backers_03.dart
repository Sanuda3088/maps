...
class LocationProvider14 extends ChangeNotifier {
...
class sp01backers_03Page extends StatefulWidget {
  const sp01backers_03Page({super.key});

  @override
  State<sp01backers_03Page> createState() => _sp01backers_03PageState();
}

class _sp01backers_03PageState extends State<sp01backers_03Page> {
  late GoogleMapController _controller;
  late LocationProvider14 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01backers_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider14>(context, listen: false);
  }
