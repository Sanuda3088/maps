...
class LocationProvider12 extends ChangeNotifier {
...
class sp01backers_01Page extends StatefulWidget {
  const sp01backers_01Page({super.key});

  @override
  State<sp01backers_01Page> createState() => _sp01backers_01PageState();
}

class _sp01backers_01PageState extends State<sp01backers_01Page> {
  late GoogleMapController _controller;
  late LocationProvider12 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01backers_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider12>(context, listen: false);
  }
