...
class LocationProvider30 extends ChangeNotifier {
...
class sp01a_02Page extends StatefulWidget {
  const sp01a_02Page({super.key});

  @override
  State<sp01a_02Page> createState() => _sp01a_02PageState();
}

class _sp01a_02PageState extends State<sp01a_02Page> {
  late GoogleMapController _controller;
  late LocationProvider30 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01a_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider30>(context, listen: false);
  }
