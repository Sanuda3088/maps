...
class LocationProvider29 extends ChangeNotifier {
...
class sp01a_01Page extends StatefulWidget {
  const sp01a_01Page({super.key});

  @override
  State<sp01a_01Page> createState() => _sp01a_01PageState();
}

class _sp01a_01PageState extends State<sp01a_01Page> {
  late GoogleMapController _controller;
  late LocationProvider29 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01a_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider29>(context, listen: false);
  }
