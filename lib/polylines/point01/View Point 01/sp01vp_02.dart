...
class LocationProvider16 extends ChangeNotifier {
...
class sp01vp_02Page extends StatefulWidget {
  const sp01vp_02Page({super.key});

  @override
  State<sp01vp_02Page> createState() => _sp01vp_02PageState();
}

class _sp01vp_02PageState extends State<sp01vp_02Page> {
  late GoogleMapController _controller;
  late LocationProvider16 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01vp_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider16>(context, listen: false);
  }
