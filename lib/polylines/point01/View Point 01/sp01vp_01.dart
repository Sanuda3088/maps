...
class LocationProvider15 extends ChangeNotifier {
...
class sp01vp_01Page extends StatefulWidget {
  const sp01vp_01Page({super.key});

  @override
  State<sp01vp_01Page> createState() => _sp01vp_01PageState();
}

class _sp01vp_01PageState extends State<sp01vp_01Page> {
  late GoogleMapController _controller;
  late LocationProvider15 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01vp_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider15>(context, listen: false);
  }
