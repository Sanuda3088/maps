...
class LocationProvider24 extends ChangeNotifier {
...
class sp01k_01Page extends StatefulWidget {
  const sp01k_01Page({super.key});

  @override
  State<sp01k_01Page> createState() => _sp01k_01PageState();
}

class _sp01k_01PageState extends State<sp01k_01Page> {
  late GoogleMapController _controller;
  late LocationProvider24 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01k_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider24>(context, listen: false);
  }
