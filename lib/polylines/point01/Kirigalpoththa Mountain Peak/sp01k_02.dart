...
class LocationProvider25 extends ChangeNotifier {
...
class sp01k_02Page extends StatefulWidget {
  const sp01k_02Page({super.key});

  @override
  State<sp01k_02Page> createState() => _sp01k_02PageState();
}

class _sp01k_02PageState extends State<sp01k_02Page> {
  late GoogleMapController _controller;
  late LocationProvider25 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01k_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider25>(context, listen: false);
  }
