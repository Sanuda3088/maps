...
class LocationProvider26 extends ChangeNotifier {
...
class sp01we_01Page extends StatefulWidget {
  const sp01we_01Page({super.key});

  @override
  State<sp01we_01Page> createState() => _sp01we_01PageState();
}

class _sp01we_01PageState extends State<sp01we_01Page> {
  late GoogleMapController _controller;
  late LocationProvider26 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01we_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider26>(context, listen: false);
  }
