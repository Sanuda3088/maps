...
class LocationProvider28 extends ChangeNotifier {
...
class sp01we_03Page extends StatefulWidget {
  const sp01we_03Page({super.key});

  @override
  State<sp01we_03Page> createState() => _sp01we_03PageState();
}

class _sp01we_03PageState extends State<sp01we_03Page> {
  late GoogleMapController _controller;
  late LocationProvider28 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01we_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider28>(context, listen: false);
  }
