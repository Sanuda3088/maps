...
class LocationProvider27 extends ChangeNotifier {
...
class sp01we_02Page extends StatefulWidget {
  const sp01we_02Page({super.key});

  @override
  State<sp01we_02Page> createState() => _sp01we_02PageState();
}

class _sp01we_02PageState extends State<sp01we_02Page> {
  late GoogleMapController _controller;
  late LocationProvider27 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01we_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider27>(context, listen: false);
  }
