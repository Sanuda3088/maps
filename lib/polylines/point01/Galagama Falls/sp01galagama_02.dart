...
class LocationProvider4 extends ChangeNotifier {
...
class sp01galagama_02Page extends StatefulWidget {
  const sp01galagama_02Page({super.key});

  @override
  State<sp01galagama_02Page> createState() => _sp01galagama_02PageState();
}

class _sp01galagama_02PageState extends State<sp01galagama_02Page> {
  late GoogleMapController _controller;
  late LocationProvider4 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.SP01galagama_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider4>(context, listen: false);
  }
