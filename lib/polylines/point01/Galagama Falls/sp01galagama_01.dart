...
class LocationProvider3 extends ChangeNotifier {
...
class sp01galagama_01Page extends StatefulWidget {
  const sp01galagama_01Page({super.key});

  @override
  State<sp01galagama_01Page> createState() => _sp01galagama_01PageState();
}

class _sp01galagama_01PageState extends State<sp01galagama_01Page> {
  late GoogleMapController _controller;
  late LocationProvider3 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.SP01galagama_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider3>(context, listen: false);
  }
