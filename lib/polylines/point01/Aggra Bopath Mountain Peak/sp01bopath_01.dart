...
class LocationProvider5 extends ChangeNotifier {
...
class sp01bopath_01Page extends StatefulWidget {
  const sp01bopath_01Page({super.key});

  @override
  State<sp01bopath_01Page> createState() => _sp01bopath_01PageState();
}

class _sp01bopath_01PageState extends State<sp01bopath_01Page> {
  late GoogleMapController _controller;
  late LocationProvider5 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01bopath_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider5>(context, listen: false);
  }
