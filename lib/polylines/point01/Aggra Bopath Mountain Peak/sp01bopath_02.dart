...
class LocationProvider6 extends ChangeNotifier {
...
class sp01bopath_02Page extends StatefulWidget {
  const sp01bopath_02Page({super.key});

  @override
  State<sp01bopath_02Page> createState() => _sp01bopath_02PageState();
}

class _sp01bopath_02PageState extends State<sp01bopath_02Page> {
  late GoogleMapController _controller;
  late LocationProvider6 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01bopath_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider6>(context, listen: false);
  }
