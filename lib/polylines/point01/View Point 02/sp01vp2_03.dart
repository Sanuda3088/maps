...
class LocationProvider20 extends ChangeNotifier {
...
class sp01vp2_03Page extends StatefulWidget {
  const sp01vp2_03Page({super.key});

  @override
  State<sp01vp2_03Page> createState() => _sp01vp2_03PageState();
}

class _sp01vp2_03PageState extends State<sp01vp2_03Page> {
  late GoogleMapController _controller;
  late LocationProvider20 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01vp2_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider20>(context, listen: false);
  }
