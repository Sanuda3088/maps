...
class LocationProvider18 extends ChangeNotifier {
...
class sp01vp2_01Page extends StatefulWidget {
  const sp01vp2_01Page({super.key});

  @override
  State<sp01vp2_01Page> createState() => _sp01vp2_01PageState();
}

class _sp01vp2_01PageState extends State<sp01vp2_01Page> {
  late GoogleMapController _controller;
  late LocationProvider18 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01vp2_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider18>(context, listen: false);
  }
