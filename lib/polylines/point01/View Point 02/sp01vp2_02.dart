...
class LocationProvider19 extends ChangeNotifier {
...
class sp01vp2_02Page extends StatefulWidget {
  const sp01vp2_02Page({super.key});

  @override
  State<sp01vp2_02Page> createState() => _sp01vp2_02PageState();
}

class _sp01vp2_02PageState extends State<sp01vp2_02Page> {
  late GoogleMapController _controller;
  late LocationProvider19 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinates.sp01vp2_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider19>(context, listen: false);
  }
