...
class LocationProvider95 extends ChangeNotifier {
...
class sp04galagama_01Page extends StatefulWidget {
  const sp04galagama_01Page({super.key});

  @override
  State<sp04galagama_01Page> createState() => _sp04galagama_01PageState();
}

class _sp04galagama_01PageState extends State<sp04galagama_01Page> {
  late GoogleMapController _controller;
  late LocationProvider95 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04galagama_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider95>(context, listen: false);
  }
