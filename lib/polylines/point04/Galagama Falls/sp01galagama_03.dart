...
class LocationProvider97 extends ChangeNotifier {
...
class sp04galagama_03Page extends StatefulWidget {
  const sp04galagama_03Page({super.key});

  @override
  State<sp04galagama_03Page> createState() => _sp04galagama_03PageState();
}

class _sp04galagama_03PageState extends State<sp04galagama_03Page> {
  late GoogleMapController _controller;
  late LocationProvider97 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04galagama_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider97>(context, listen: false);
  }
