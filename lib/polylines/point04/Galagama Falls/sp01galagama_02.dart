...
import 'package:maps/coordinates/point02_part02_Coordinates.dart';
import 'package:maps/coordinates/point04_Coordinates.dart';
import 'package:provider/provider.dart';
import 'dart:async' show Future;

class LocationProvider96 extends ChangeNotifier {
...
class sp04galagama_02Page extends StatefulWidget {
  const sp04galagama_02Page({super.key});

  @override
  State<sp04galagama_02Page> createState() => _sp04galagama_02PageState();
}

class _sp04galagama_02PageState extends State<sp04galagama_02Page> {
  late GoogleMapController _controller;
  late LocationProvider96 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04galagama_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider96>(context, listen: false);
  }
