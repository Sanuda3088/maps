...
class LocationProvider100 extends ChangeNotifier {
...
class sp04k_02Page extends StatefulWidget {
  const sp04k_02Page({super.key});

  @override
  State<sp04k_02Page> createState() => _sp04k_02PageState();
}

class _sp04k_02PageState extends State<sp04k_02Page> {
  late GoogleMapController _controller;
  late LocationProvider100 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04k_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider100>(context, listen: false);
  }
