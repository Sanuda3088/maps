...
class LocationProvider101 extends ChangeNotifier {
...
class sp04k_01Page extends StatefulWidget {
  const sp04k_01Page({super.key});

  @override
  State<sp04k_01Page> createState() => _sp04k_01PageState();
}

class _sp04k_01PageState extends State<sp04k_01Page> {
  late GoogleMapController _controller;
  late LocationProvider101 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04k_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider101>(context, listen: false);
  }
