...
class LocationProvider104 extends ChangeNotifier {
...
class sp04newz_02Page extends StatefulWidget {
  const sp04newz_02Page({super.key});

  @override
  State<sp04newz_02Page> createState() => _sp04newz_02PageState();
}

class _sp04newz_02PageState extends State<sp04newz_02Page> {
  late GoogleMapController _controller;
  late LocationProvider104 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04nwz_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider104>(context, listen: false);
  }
