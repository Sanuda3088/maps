...
class LocationProvider103 extends ChangeNotifier {
...
class sp04newz_01Page extends StatefulWidget {
  const sp04newz_01Page({super.key});

  @override
  State<sp04newz_01Page> createState() => _sp04newz_01PageState();
}

class _sp04newz_01PageState extends State<sp04newz_01Page> {
  late GoogleMapController _controller;
  late LocationProvider103 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04nwz_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider103>(context, listen: false);
  }
