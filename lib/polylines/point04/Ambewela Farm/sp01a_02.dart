...
class LocationProvider92 extends ChangeNotifier {
...
class sp04a_02Page extends StatefulWidget {
  const sp04a_02Page({super.key});

  @override
  State<sp04a_02Page> createState() => _sp04a_02PageState();
}

class _sp04a_02PageState extends State<sp04a_02Page> {
  late GoogleMapController _controller;
  late LocationProvider92 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04a_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider92>(context, listen: false);
  }
