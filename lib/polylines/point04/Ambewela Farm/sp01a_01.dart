...
class LocationProvider91 extends ChangeNotifier {
...
class sp04a_01Page extends StatefulWidget {
  const sp04a_01Page({super.key});

  @override
  State<sp04a_01Page> createState() => _sp04a_01PageState();
}

class _sp04a_01PageState extends State<sp04a_01Page> {
  late GoogleMapController _controller;
  late LocationProvider91 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04a_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider91>(context, listen: false);
  }
