...
class LocationProvider94 extends ChangeNotifier {
...
class sp04backers_02Page extends StatefulWidget {
  const sp04backers_02Page({super.key});

  @override
  State<sp04backers_02Page> createState() => _sp04backers_02PageState();
}

class _sp04backers_02PageState extends State<sp04backers_02Page> {
  late GoogleMapController _controller;
  late LocationProvider94 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04backers_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider94>(context, listen: false);
  }
