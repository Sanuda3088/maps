...
class LocationProvider93 extends ChangeNotifier {
...
class sp04backers_01Page extends StatefulWidget {
  const sp04backers_01Page({super.key});

  @override
  State<sp04backers_01Page> createState() => _sp04backers_01PageState();
}

class _sp04backers_01PageState extends State<sp04backers_01Page> {
  late GoogleMapController _controller;
  late LocationProvider93 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04backers_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider93>(context, listen: false);
  }
