...
class LocationProvider87 extends ChangeNotifier {
...
class sp04bopath_01Page extends StatefulWidget {
  const sp04bopath_01Page({super.key});

  @override
  State<sp04bopath_01Page> createState() => _sp04bopath_01PageState();
}

class _sp04bopath_01PageState extends State<sp04bopath_01Page> {
  late GoogleMapController _controller;
  late LocationProvider87 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04bopath_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider87>(context, listen: false);
  }
