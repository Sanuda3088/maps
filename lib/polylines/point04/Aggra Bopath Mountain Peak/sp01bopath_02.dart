...
class LocationProvider88 extends ChangeNotifier {
...
class sp04bopath_02Page extends StatefulWidget {
  const sp04bopath_02Page({super.key});

  @override
  State<sp04bopath_02Page> createState() => _sp04bopath_02PageState();
}

class _sp04bopath_02PageState extends State<sp04bopath_02Page> {
  late GoogleMapController _controller;
  late LocationProvider88 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04bopath_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider88>(context, listen: false);
  }
