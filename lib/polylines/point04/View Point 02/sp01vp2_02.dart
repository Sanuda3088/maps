...
class LocationProvider108 extends ChangeNotifier {
...
class sp04vp2_02Page extends StatefulWidget {
  const sp04vp2_02Page({super.key});

  @override
  State<sp04vp2_02Page> createState() => _sp04vp2_02PageState();
}

class _sp04vp2_02PageState extends State<sp04vp2_02Page> {
  late GoogleMapController _controller;
  late LocationProvider108 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04part02.sp04vp02_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider108>(context, listen: false);
  }
