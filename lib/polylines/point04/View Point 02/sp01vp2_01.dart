...
import 'package:maps/coordinates/point04_part02_Coordinates.dart';
import 'package:provider/provider.dart';
import 'dart:async' show Future;

class LocationProvider107 extends ChangeNotifier {
...
class sp04vp2_01Page extends StatefulWidget {
  const sp04vp2_01Page({super.key});

  @override
  State<sp04vp2_01Page> createState() => _sp04vp2_01PageState();
}

class _sp04vp2_01PageState extends State<sp04vp2_01Page> {
  late GoogleMapController _controller;
  late LocationProvider107 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04part02.sp04vp02_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider107>(context, listen: false);
  }
