...
class LocationProvider90 extends ChangeNotifier {
...
class sp04aggra_01Page extends StatefulWidget {
  const sp04aggra_01Page({super.key});

  @override
  State<sp04aggra_01Page> createState() => _sp04aggra_01PageState();
}

class _sp04aggra_01PageState extends State<sp04aggra_01Page> {
  late GoogleMapController _controller;
  late LocationProvider90 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04aggra_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider90>(context, listen: false);
  }
