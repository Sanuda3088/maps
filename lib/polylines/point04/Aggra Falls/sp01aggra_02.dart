...
class LocationProvider89 extends ChangeNotifier {
...
class sp04aggra_02Page extends StatefulWidget {
  const sp04aggra_02Page({super.key});

  @override
  State<sp04aggra_02Page> createState() => _sp04aggra_02PageState();
}

class _sp04aggra_02PageState extends State<sp04aggra_02Page> {
  late GoogleMapController _controller;
  late LocationProvider89 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04aggra_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider89>(context, listen: false);
  }
