...
class LocationProvider98 extends ChangeNotifier {
...
class sp04we_01Page extends StatefulWidget {
  const sp04we_01Page({super.key});

  @override
  State<sp04we_01Page> createState() => _sp04we_01PageState();
}

class _sp04we_01PageState extends State<sp04we_01Page> {
  late GoogleMapController _controller;
  late LocationProvider98 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04we_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider98>(context, listen: false);
  }
