...
class LocationProvider99 extends ChangeNotifier {
...
class sp04we_02Page extends StatefulWidget {
  const sp04we_02Page({super.key});

  @override
  State<sp04we_02Page> createState() => _sp04we_02PageState();
}

class _sp04we_02PageState extends State<sp04we_02Page> {
  late GoogleMapController _controller;
  late LocationProvider99 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04we_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider99>(context, listen: false);
  }
