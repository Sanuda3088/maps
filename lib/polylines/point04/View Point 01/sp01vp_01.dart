...
class LocationProvider105 extends ChangeNotifier {
...
class sp04vp_01Page extends StatefulWidget {
  const sp04vp_01Page({super.key});

  @override
  State<sp04vp_01Page> createState() => _sp04vp_01PageState();
}

class _sp04vp_01PageState extends State<sp04vp_01Page> {
  late GoogleMapController _controller;
  late LocationProvider105 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04part02.sp04vp_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider105>(context, listen: false);
  }
