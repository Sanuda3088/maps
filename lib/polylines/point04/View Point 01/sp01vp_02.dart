...
class LocationProvider106 extends ChangeNotifier {
...
class sp04vp_02Page extends StatefulWidget {
  const sp04vp_02Page({super.key});

  @override
  State<sp04vp_02Page> createState() => _sp04vp_02PageState();
}

class _sp04vp_02PageState extends State<sp04vp_02Page> {
  late GoogleMapController _controller;
  late LocationProvider106 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04part02.sp04vp_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider106>(context, listen: false);
  }
