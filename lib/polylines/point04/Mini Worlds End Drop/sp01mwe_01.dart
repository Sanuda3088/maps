...
class LocationProvider102 extends ChangeNotifier {
...
class sp04mwe_01Page extends StatefulWidget {
  const sp04mwe_01Page({super.key});

  @override
  State<sp04mwe_01Page> createState() => _sp04mwe_01PageState();
}

class _sp04mwe_01PageState extends State<sp04mwe_01Page> {
  late GoogleMapController _controller;
  late LocationProvider102 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint04.sp04mwe_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider102>(context, listen: false);
  }
