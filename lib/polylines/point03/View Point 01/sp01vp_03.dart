...
class LocationProvider84 extends ChangeNotifier {
...
class sp03vp_03Page extends StatefulWidget {
  const sp03vp_03Page({super.key});

  @override
  State<sp03vp_03Page> createState() => _sp03vp_03PageState();
}

class _sp03vp_03PageState extends State<sp03vp_03Page> {
  late GoogleMapController _controller;
  late LocationProvider84 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03part02.sp03vp_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider84>(context, listen: false);
  }
