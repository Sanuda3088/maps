...
class LocationProvider83 extends ChangeNotifier {
...
class sp03vp_02Page extends StatefulWidget {
  const sp03vp_02Page({super.key});

  @override
  State<sp03vp_02Page> createState() => _sp03vp_02PageState();
}

class _sp03vp_02PageState extends State<sp03vp_02Page> {
  late GoogleMapController _controller;
  late LocationProvider83 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03part02.sp03vp_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider83>(context, listen: false);
  }
