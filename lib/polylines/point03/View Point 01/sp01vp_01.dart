...
class LocationProvider82 extends ChangeNotifier {
...
class sp03vp_01Page extends StatefulWidget {
  const sp03vp_01Page({super.key});

  @override
  State<sp03vp_01Page> createState() => _sp03vp_01PageState();
}

class _sp03vp_01PageState extends State<sp03vp_01Page> {
  late GoogleMapController _controller;
  late LocationProvider82 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03part02.sp03vp_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider82>(context, listen: false);
  }
