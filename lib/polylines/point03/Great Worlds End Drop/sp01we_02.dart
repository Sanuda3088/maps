...
class LocationProvider73 extends ChangeNotifier {
...
class sp03we_02Page extends StatefulWidget {
  const sp03we_02Page({super.key});

  @override
  State<sp03we_02Page> createState() => _sp03we_02PageState();
}

class _sp03we_02PageState extends State<sp03we_02Page> {
  late GoogleMapController _controller;
  late LocationProvider73 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03we_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider73>(context, listen: false);
  }
