...
class LocationProvider72 extends ChangeNotifier {
...
class sp03we_01Page extends StatefulWidget {
  const sp03we_01Page({super.key});

  @override
  State<sp03we_01Page> createState() => _sp03we_01PageState();
}

class _sp03we_01PageState extends State<sp03we_01Page> {
  late GoogleMapController _controller;
  late LocationProvider72 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03we_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider72>(context, listen: false);
  }
