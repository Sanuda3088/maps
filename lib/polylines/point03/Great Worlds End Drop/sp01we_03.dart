...
class LocationProvider74 extends ChangeNotifier {
...
class sp03we_03Page extends StatefulWidget {
  const sp03we_03Page({super.key});

  @override
  State<sp03we_03Page> createState() => _sp03we_03PageState();
}

class _sp03we_03PageState extends State<sp03we_03Page> {
  late GoogleMapController _controller;
  late LocationProvider74 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03we_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider74>(context, listen: false);
  }
