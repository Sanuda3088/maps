...
class LocationProvider65 extends ChangeNotifier {
...
class sp03aggra_02Page extends StatefulWidget {
  const sp03aggra_02Page({super.key});

  @override
  State<sp03aggra_02Page> createState() => _sp03aggra_02PageState();
}

class _sp03aggra_02PageState extends State<sp03aggra_02Page> {
  late GoogleMapController _controller;
  late LocationProvider65 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03aggra_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider65>(context, listen: false);
  }
