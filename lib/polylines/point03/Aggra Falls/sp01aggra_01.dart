...
class LocationProvider64 extends ChangeNotifier {
...
class sp03aggra_01Page extends StatefulWidget {
  const sp03aggra_01Page({super.key});

  @override
  State<sp03aggra_01Page> createState() => _sp03aggra_01PageState();
}

class _sp03aggra_01PageState extends State<sp03aggra_01Page> {
  late GoogleMapController _controller;
  late LocationProvider64 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03aggra_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider64>(context, listen: false);
  }
