...
class LocationProvider66 extends ChangeNotifier {
...
class sp03a_01Page extends StatefulWidget {
  const sp03a_01Page({super.key});

  @override
  State<sp03a_01Page> createState() => _sp03a_01PageState();
}

class _sp03a_01PageState extends State<sp03a_01Page> {
  late GoogleMapController _controller;
  late LocationProvider66 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03a_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider66>(context, listen: false);
  }
