...
class LocationProvider86 extends ChangeNotifier {
...
class sp03vp2_01Page extends StatefulWidget {
  const sp03vp2_01Page({super.key});

  @override
  State<sp03vp2_01Page> createState() => _sp03vp2_01PageState();
}

class _sp03vp2_01PageState extends State<sp03vp2_01Page> {
  late GoogleMapController _controller;
  late LocationProvider86 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03part02.sp03vp02_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider86>(context, listen: false);
  }
