...
import 'package:maps/coordinates/point03_Coordinates.dart';
import 'package:provider/provider.dart';
import 'dart:async' show Future;

class LocationProvider71 extends ChangeNotifier {
...
class sp03galagama_03Page extends StatefulWidget {
  const sp03galagama_03Page({super.key});

  @override
  State<sp03galagama_03Page> createState() => _sp03galagama_03PageState();
}

class _sp03galagama_03PageState extends State<sp03galagama_03Page> {
  late GoogleMapController _controller;
  late LocationProvider71 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03galagama_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider71>(context, listen: false);
  }
