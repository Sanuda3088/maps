...
class LocationProvider69 extends ChangeNotifier {
...
class sp03galagama_01Page extends StatefulWidget {
  const sp03galagama_01Page({super.key});

  @override
  State<sp03galagama_01Page> createState() => _sp03galagama_01PageState();
}

class _sp03galagama_01PageState extends State<sp03galagama_01Page> {
  late GoogleMapController _controller;
  late LocationProvider69 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03galagama_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider69>(context, listen: false);
  }
