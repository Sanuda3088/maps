...
class LocationProvider70 extends ChangeNotifier {
...
class sp03galagama_02Page extends StatefulWidget {
  const sp03galagama_02Page({super.key});

  @override
  State<sp03galagama_02Page> createState() => _sp03galagama_02PageState();
}

class _sp03galagama_02PageState extends State<sp03galagama_02Page> {
  late GoogleMapController _controller;
  late LocationProvider70 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03galagama_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider70>(context, listen: false);
  }
