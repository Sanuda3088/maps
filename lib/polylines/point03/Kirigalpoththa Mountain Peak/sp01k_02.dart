...
class LocationProvider76 extends ChangeNotifier {
...
class sp03k_02Page extends StatefulWidget {
  const sp03k_02Page({super.key});

  @override
  State<sp03k_02Page> createState() => _sp03k_02PageState();
}

class _sp03k_02PageState extends State<sp03k_02Page> {
  late GoogleMapController _controller;
  late LocationProvider76 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03k_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider76>(context, listen: false);
  }
