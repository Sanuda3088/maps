...
class LocationProvider75 extends ChangeNotifier {
...
class sp03k_01Page extends StatefulWidget {
  const sp03k_01Page({super.key});

  @override
  State<sp03k_01Page> createState() => _sp03k_01PageState();
}

class _sp03k_01PageState extends State<sp03k_01Page> {
  late GoogleMapController _controller;
  late LocationProvider75 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03k_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider75>(context, listen: false);
  }
