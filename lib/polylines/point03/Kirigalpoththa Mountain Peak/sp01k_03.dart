...
class LocationProvider77 extends ChangeNotifier {
...
class sp03k_03Page extends StatefulWidget {
  const sp03k_03Page({super.key});

  @override
  State<sp03k_03Page> createState() => _sp03k_03PageState();
}

class _sp03k_03PageState extends State<sp03k_03Page> {
  late GoogleMapController _controller;
  late LocationProvider77 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03k_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider77>(context, listen: false);
  }
