...
import 'package:maps/coordinates/point03_part02_Coordinates.dart';
import 'package:provider/provider.dart';
import 'dart:async' show Future;

class LocationProvider81 extends ChangeNotifier {
...
class sp03newz_02Page extends StatefulWidget {
  const sp03newz_02Page({super.key});

  @override
  State<sp03newz_02Page> createState() => _sp03newz_02PageState();
}

class _sp03newz_02PageState extends State<sp03newz_02Page> {
  late GoogleMapController _controller;
  late LocationProvider81 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03part02.sp03nwz_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider81>(context, listen: false);
  }
