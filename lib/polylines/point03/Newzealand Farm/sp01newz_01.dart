...
class LocationProvider80 extends ChangeNotifier {
...
class sp03newz_01Page extends StatefulWidget {
  const sp03newz_01Page({super.key});

  @override
  State<sp03newz_01Page> createState() => _sp03newz_01PageState();
}

class _sp03newz_01PageState extends State<sp03newz_01Page> {
  late GoogleMapController _controller;
  late LocationProvider80 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03part02.sp03nwz_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider80>(context, listen: false);
  }
