...
class LocationProvider78 extends ChangeNotifier {
...
class sp03mwe_01Page extends StatefulWidget {
  const sp03mwe_01Page({super.key});

  @override
  State<sp03mwe_01Page> createState() => _sp03mwe_01PageState();
}

class _sp03mwe_01PageState extends State<sp03mwe_01Page> {
  late GoogleMapController _controller;
  late LocationProvider78 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03mwe_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider78>(context, listen: false);
  }
