...
class LocationProvider79 extends ChangeNotifier {
...
class sp03mwe_02Page extends StatefulWidget {
  const sp03mwe_02Page({super.key});

  @override
  State<sp03mwe_02Page> createState() => _sp03mwe_02PageState();
}

class _sp03mwe_02PageState extends State<sp03mwe_02Page> {
  late GoogleMapController _controller;
  late LocationProvider79 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint03.sp03mwe_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider79>(context, listen: false);
  }
