...
class LocationProvider51 extends ChangeNotifier {
...
class sp02we_01Page extends StatefulWidget {
  const sp02we_01Page({super.key});

  @override
  State<sp02we_01Page> createState() => _sp02we_01PageState();
}

class _sp02we_01PageState extends State<sp02we_01Page> {
  late GoogleMapController _controller;
  late LocationProvider51 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02we_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider51>(context, listen: false);
  }
