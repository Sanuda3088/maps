...
class LocationProvider52 extends ChangeNotifier {
...
class sp02we_02Page extends StatefulWidget {
  const sp02we_02Page({super.key});

  @override
  State<sp02we_02Page> createState() => _sp02we_02PageState();
}

class _sp02we_02PageState extends State<sp02we_02Page> {
  late GoogleMapController _controller;
  late LocationProvider52 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02we_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider52>(context, listen: false);
  }
