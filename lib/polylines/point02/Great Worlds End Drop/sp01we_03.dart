...
class LocationProvider53 extends ChangeNotifier {
...
class sp02we_03Page extends StatefulWidget {
  const sp02we_03Page({super.key});

  @override
  State<sp02we_03Page> createState() => _sp02we_03PageState();
}

class _sp02we_03PageState extends State<sp02we_03Page> {
  late GoogleMapController _controller;
  late LocationProvider53 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02we_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider53>(context, listen: false);
  }
