...
class LocationProvider34 extends ChangeNotifier {
...
class sp02aggra_01Page extends StatefulWidget {
  const sp02aggra_01Page({super.key});

  @override
  State<sp02aggra_01Page> createState() => _sp02aggra_01PageState();
}

class _sp02aggra_01PageState extends State<sp02aggra_01Page> {
  late GoogleMapController _controller;
  late LocationProvider34 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02.sp02aggra_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider34>(context, listen: false);
  }
