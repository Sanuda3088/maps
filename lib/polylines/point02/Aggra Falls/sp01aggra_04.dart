...
class LocationProvider36 extends ChangeNotifier {
...
class sp02aggra_04Page extends StatefulWidget {
  const sp02aggra_04Page({super.key});

  @override
  State<sp02aggra_04Page> createState() => _sp02aggra_04PageState();
}

class _sp02aggra_04PageState extends State<sp02aggra_04Page> {
  late GoogleMapController _controller;
  late LocationProvider36 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02.sp02aggra_04;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider36>(context, listen: false);
  }
