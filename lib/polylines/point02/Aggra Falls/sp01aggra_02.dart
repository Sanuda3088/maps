...
class LocationProvider35 extends ChangeNotifier {
...
class sp02aggra_02Page extends StatefulWidget {
  const sp02aggra_02Page({super.key});

  @override
  State<sp02aggra_02Page> createState() => _sp02aggra_02PageState();
}

class _sp02aggra_02PageState extends State<sp02aggra_02Page> {
  late GoogleMapController _controller;
  late LocationProvider35 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02.sp02aggra_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider35>(context, listen: false);
  }
