...
class LocationProvider31 extends ChangeNotifier {
...
class sp02bopath_01Page extends StatefulWidget {
  const sp02bopath_01Page({super.key});

  @override
  State<sp02bopath_01Page> createState() => _sp02bopath_01PageState();
}

class _sp02bopath_01PageState extends State<sp02bopath_01Page> {
  late GoogleMapController _controller;
  late LocationProvider31 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02.sp02bopath_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider31>(context, listen: false);
  }
