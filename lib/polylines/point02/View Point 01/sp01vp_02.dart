...
class LocationProvider38 extends ChangeNotifier {
...
class sp02vp_02Page extends StatefulWidget {
  const sp02vp_02Page({super.key});

  @override
  State<sp02vp_02Page> createState() => _sp02vp_02PageState();
}

class _sp02vp_02PageState extends State<sp02vp_02Page> {
  late GoogleMapController _controller;
  late LocationProvider38 _locationProvider;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider38>(context, listen: false);
  }
