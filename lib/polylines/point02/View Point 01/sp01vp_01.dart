...
class LocationProvider37 extends ChangeNotifier {
...
class sp02vp_01Page extends StatefulWidget {
  const sp02vp_01Page({super.key});

  @override
  State<sp02vp_01Page> createState() => _sp02vp_01PageState();
}

class _sp02vp_01PageState extends State<sp02vp_01Page> {
  late GoogleMapController _controller;
  late LocationProvider37 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02.sp02vp_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider37>(context, listen: false);
  }
