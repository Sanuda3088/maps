...
class LocationProvider50 extends ChangeNotifier {
...
class sp02galagama_03Page extends StatefulWidget {
  const sp02galagama_03Page({super.key});

  @override
  State<sp02galagama_03Page> createState() => _sp02galagama_03PageState();
}

class _sp02galagama_03PageState extends State<sp02galagama_03Page> {
  late GoogleMapController _controller;
  late LocationProvider50 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02galagama_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider50>(context, listen: false);
  }
