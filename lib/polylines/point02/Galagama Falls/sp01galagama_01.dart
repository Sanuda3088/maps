...
class LocationProvider48 extends ChangeNotifier {
...
class sp02galagama_01Page extends StatefulWidget {
  const sp02galagama_01Page({super.key});

  @override
  State<sp02galagama_01Page> createState() => _sp02galagama_01PageState();
}

class _sp02galagama_01PageState extends State<sp02galagama_01Page> {
  late GoogleMapController _controller;
  late LocationProvider48 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02galagama_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider48>(context, listen: false);
  }
