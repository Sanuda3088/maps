...
class LocationProvider49 extends ChangeNotifier {
...
class sp02galagama_02Page extends StatefulWidget {
  const sp02galagama_02Page({super.key});

  @override
  State<sp02galagama_02Page> createState() => _sp02galagama_02PageState();
}

class _sp02galagama_02PageState extends State<sp02galagama_02Page> {
  late GoogleMapController _controller;
  late LocationProvider49 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02galagama_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider49>(context, listen: false);
  }
