...
class LocationProvider61 extends ChangeNotifier {
...
class sp02k_03Page extends StatefulWidget {
  const sp02k_03Page({super.key});

  @override
  State<sp02k_03Page> createState() => _sp02k_03PageState();
}

class _sp02k_03PageState extends State<sp02k_03Page> {
  late GoogleMapController _controller;
  late LocationProvider61 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02k_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider61>(context, listen: false);
  }
