...
class LocationProvider59 extends ChangeNotifier {
...
class sp02k_01Page extends StatefulWidget {
  const sp02k_01Page({super.key});

  @override
  State<sp02k_01Page> createState() => _sp02k_01PageState();
}

class _sp02k_01PageState extends State<sp02k_01Page> {
  late GoogleMapController _controller;
  late LocationProvider59 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02k_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider59>(context, listen: false);
  }
