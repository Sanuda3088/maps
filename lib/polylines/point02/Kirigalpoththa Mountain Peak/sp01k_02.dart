...
class LocationProvider60 extends ChangeNotifier {
...
class sp02k_02Page extends StatefulWidget {
  const sp02k_02Page({super.key});

  @override
  State<sp02k_02Page> createState() => _sp02k_02PageState();
}

class _sp02k_02PageState extends State<sp02k_02Page> {
  late GoogleMapController _controller;
  late LocationProvider60 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02k_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider60>(context, listen: false);
  }
