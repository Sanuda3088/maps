...
class LocationProvider40 extends ChangeNotifier {
...
class sp02vp2_02Page extends StatefulWidget {
  const sp02vp2_02Page({super.key});

  @override
  State<sp02vp2_02Page> createState() => _sp02vp2_02PageState();
}

class _sp02vp2_02PageState extends State<sp02vp2_02Page> {
  late GoogleMapController _controller;
  late LocationProvider40 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02.sp02vp_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider40>(context, listen: false);
  }
