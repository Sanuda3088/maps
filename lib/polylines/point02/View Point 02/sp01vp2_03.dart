...
class LocationProvider41 extends ChangeNotifier {
...
class sp02vp2_03Page extends StatefulWidget {
  const sp02vp2_03Page({super.key});

  @override
  State<sp02vp2_03Page> createState() => _sp02vp2_03PageState();
}

class _sp02vp2_03PageState extends State<sp02vp2_03Page> {
  late GoogleMapController _controller;
  late LocationProvider41 _locationProvider;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider41>(context, listen: false);
  }
