...
class LocationProvider46 extends ChangeNotifier {
...
class sp02backers_02Page extends StatefulWidget {
  const sp02backers_02Page({super.key});

  @override
  State<sp02backers_02Page> createState() => _sp02backers_02PageState();
}

class _sp02backers_02PageState extends State<sp02backers_02Page> {
  late GoogleMapController _controller;
  late LocationProvider46 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02backers_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider46>(context, listen: false);
  }
