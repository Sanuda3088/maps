...
class LocationProvider56 extends ChangeNotifier {
...
class sp02newz_01Page extends StatefulWidget {
  const sp02newz_01Page({super.key});

  @override
  State<sp02newz_01Page> createState() => _sp02newz_01PageState();
}

class _sp02newz_01PageState extends State<sp02newz_01Page> {
  late GoogleMapController _controller;
  late LocationProvider56 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02newz_01;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider56>(context, listen: false);
  }
