...
class LocationProvider58 extends ChangeNotifier {
...
class sp02newz_03Page extends StatefulWidget {
  const sp02newz_03Page({super.key});

  @override
  State<sp02newz_03Page> createState() => _sp02newz_03PageState();
}

class _sp02newz_03PageState extends State<sp02newz_03Page> {
  late GoogleMapController _controller;
  late LocationProvider58 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02newz_03;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider58>(context, listen: false);
  }
