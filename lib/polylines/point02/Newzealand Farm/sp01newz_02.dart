...
class LocationProvider57 extends ChangeNotifier {
...
class sp02newz_02Page extends StatefulWidget {
  const sp02newz_02Page({super.key});

  @override
  State<sp02newz_02Page> createState() => _sp02newz_02PageState();
}

class _sp02newz_02PageState extends State<sp02newz_02Page> {
  late GoogleMapController _controller;
  late LocationProvider57 _locationProvider;
  final location.Location _location = location.Location();
  MapType _mapType = MapType.normal;
  bool _centerOnLocation = true;

  // Define a list of LatLng points for your polyline
  List<LatLng> polylineCoordinates02 = polylineCoordinatespoint02part02.sp02newz_02;
  ...
  void initState() {
    super.initState();
    _locationProvider = Provider.of<LocationProvider57>(context, listen: false);
  }
